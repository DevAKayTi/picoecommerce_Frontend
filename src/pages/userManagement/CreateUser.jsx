...
const CreateUser = () => {
    ...
    useEffect(()=>{
        const fetchUser =async()=>{
            try{
                const response = await http.get('/api/users/create');
        ...
        <>
            ...
            <Formik 
                ...
                onSubmit={async(values,{setSubmitting})=>{
                    ...
                    try{ 
                        await http.post('/api/users/store',
                            user
                        ).then(
                            response =>{
                            if(response){
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='bg-white p-6 rounded-md shadow-md mb-10'>
                                <div className='w-full pb-10'>
                                    ...
                                    <div className='flex'>
                                        <label className='text-gray-600 ftex font-semibold flex mt-8 mr-4 check-forms'>
                            ...
                            <div className='bg-white p-6 rounded-md shadow-md'>
                                <h3 className='text-lg font-semibold'>Roles and Permissions</h3>
                                    <div className='w-full md:flex mt-10'>
                                        ...
                                        <div className='form-grid mb-4 w-full md:pl-3'>
                                            <label htmlFor="role" className='form-labels font-semibold text-medium text-gray-600'>Role</label>
                                            <FormSelect>
                                                <select name='role' value={values.role} className='w-full' onChange={handleChange}>
                                                    {
                                                        role.map((val)=>(
